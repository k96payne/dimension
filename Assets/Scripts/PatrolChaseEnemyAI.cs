...
public class PatrolChaseEnemyAI : MonoBehaviour
{
    public int health;
    ...
    public StateMachine<PatrolChaseEnemyAI> stateMachine { get; set; }

    private void Start()
    {
        stateMachine = new StateMachine<PatrolChaseEnemyAI>(this);
        stateMachine.ChangeState(PatrolState1.Instance);
